...
def validate_json(schema: Type[T], required: bool = True) -> Union[T, dict]:
    """
...
def validate_query_params(schema: Type[T]) -> Union[T, dict]:
    """
...
def create_response(data: Union[BaseModel, dict, list], status_code: int = 200) -> tuple:
    """
