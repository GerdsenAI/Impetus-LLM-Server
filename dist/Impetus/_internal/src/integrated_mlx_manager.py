...
from apple_frameworks_integration import (
    AppleFrameworksIntegration, 
    ComputeDevice, 
    ModelFormat,
    OptimizationLevel
)
...
class IntegratedMLXManager:
    ...
    def _determine_optimal_device(self, model_path: str) -> ComputeDevice:
        ...
        try:
            ...
            # Check thermal state
            if self.silicon_detector.current_thermal_state in [ThermalState.HOT, ThermalState.THROTTLED]:
